...
Future<void> main() async {
  ...
  await Supabase.initialize(
    url: 'https://jupamzsisqtnyacefgby.supabase.co',
    anonKey: 'sb_publishable_XhRZoezZ_8sjHKJ3bpG_YA_UKFgndxo',
  );
    ...
    MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(
          create: (_) => HistoricalDataViewModel(
            HistoricalDataRepository(),
          ),
        ),
      ],
      child: const GoldifyApp(),
    ),
  );
}
...
class _GoldifyAppState extends State<GoldifyApp> {
  ...
  void _openNewPasswordPage() {
    debugPrint(
      'TRYING TO OPEN NEW PASSWORD PAGE...',
    );
    ...
    Future.delayed(
      ...
      () {
        ...
        debugPrint(
          'NAVIGATOR STATE: '
          '${navigator != null ? "AVAILABLE" : "NULL"}',
        );

        if (navigator == null) {
          debugPrint(
            'NAVIGATOR NOT READY - RETRYING...',
          );
