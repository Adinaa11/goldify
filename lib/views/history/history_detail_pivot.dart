              ...
              Center(
                child: Text(
                  ...
                  style: const TextStyle(
                    ...
                    fontSize: 36,
                    fontWeight: FontWeight.bold,
                    color: Color.fromARGB(255, 243, 130, 0),
                  ),
                ),
              ),
              const SizedBox(height: 4),
  ...
  Future<void> _download() async {
    try {
      ...
      await Gal.putImageBytes(
        ...
        album: 'EWF Pivot',
        name:
            'pivot_history_${DateTime.now().millisecondsSinceEpoch}',
      );
